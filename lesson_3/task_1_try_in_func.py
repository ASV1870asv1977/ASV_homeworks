...
def my_division(divddend, divider):
    """
    Функция делит два числа с исключением ошибки деления на ноль. При делении
    на ноль возвращает None
...
while True:
    ...
    if my_division(my_list[0], my_list[1]) == None: continue
